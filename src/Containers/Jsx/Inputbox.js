        ...
        <div>
          <form onSubmit={this.handleUploadImage}>
            ...
            <div>
              ...
              <br />
              <h3 style={{ fontWeight: "bold", color: "white" }}>
                Bitzoom is live from 9pm till 1am every day.
              </h3>
              <br />
              <h3 style={{ fontWeight: "bold", color: "white" }}>
                It is a sincere request to all, to atleast upload a question
                paper or some notes to update our content and help bitzoom in
                its purpose.
              </h3>
              <br />
              <h3 style={{ fontWeight: "bold", color: "white" }}>
                We want active participation from each one of you or else we
                will have to shut down the website.
              </h3>
              <br />
              <button
